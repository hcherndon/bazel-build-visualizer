 ...
 *
 * <p>Lifted out of {@link BazelLauncher} unchanged so that the ladder that
 * chooses the rungs and the code that delivers them can be tested apart. Every
 * decision here was measured against real Bazel binaries and the reasoning is
 * kept with the code that depends on it.
 */
