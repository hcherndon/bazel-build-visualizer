...
/**
 * The selected Bazel could not be identified, so nothing may be launched with
 * it.
 *
 * <p>Carries what the user entered as well as the reason, because the two are
 * usually both needed to fix it: "bazel" and "no such executable on this
 * machine" together say something that neither says alone.
 */
