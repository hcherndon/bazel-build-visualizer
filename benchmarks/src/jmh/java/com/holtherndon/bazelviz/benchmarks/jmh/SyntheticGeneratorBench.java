...
/**
 * Cost floor of {@link SyntheticActionGenerator#actionAt(long)}. Every table, timeline, and SQL
 * benchmark draws rows from this generator, so its per-row cost is the baseline to subtract when
