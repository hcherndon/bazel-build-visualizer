...
| Repository browser visible entries | `com.holtherndon.bazelviz.ui.repository.RepositoryBrowserView.DEFAULT_VISIBLE_ENTRY_LIMIT` | 5000 | Further expansion is refused with an explicit limit message. Directories remain lazy and the tree never claims the repository itself was truncated. |
