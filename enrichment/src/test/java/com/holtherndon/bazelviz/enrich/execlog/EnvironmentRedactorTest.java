 ...
 *
 * <p>Plan 22.2 requires the default patterns and requires them to be editable.
 * The interesting property is not which names match — it is that a withheld
 * value stays distinguishable from an absent one, because a user asking "why
 * did this action behave differently" needs to know a variable was set.
 */
final class EnvironmentRedactorTest {
    ...
    void theTypeRefusesToLeak() {
        ...
        org.assertj.core.api.Assertions.assertThatThrownBy(() ->
                        new EnvVar("TOKEN", java.util.Optional.of("leaked"), true))
