...
class ByteTotalTest {
  ...
  void unknownSizesMakeTheTotalInexact() {
    ByteTotal total = ByteTotal.EMPTY.plusKnown(1_000).plusKnown(2_000).plusUnknown();
  ...
  void duplicateReferencesDoNotInflateTheTotal() {
    ByteTotal total =
        ByteTotal.EMPTY.plusKnown(500).plusDuplicateReference().plusDuplicateReference();
