 ...
 *
 * <p>Every derived value carries its provenance so the inspector can show it, and so conflicting
 * measurements from different sources are kept apart rather than collapsed into one unexplained
 * number (ADR-009).
 */
