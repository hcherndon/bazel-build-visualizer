 ...
 *
 * <p>It copies {@code rawBytes} on receipt, exactly as the parser's contract requires of any caller
 * that retains a record beyond the callback. Doing so here rather than trusting the parser also
 * means a test that compares bytes is comparing what the listener was actually handed.
 */
