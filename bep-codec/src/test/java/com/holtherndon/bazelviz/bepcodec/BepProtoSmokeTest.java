...
/**
 * Proves the vendored proto definitions in :proto actually produce usable generated code on this
 * module's classpath (java codegen for the BEP stream, grpc codegen for the BES service) before any
 * real codec work builds on them.
 */
final class BepProtoSmokeTest {

  @Test
  void buildEventRoundTripsThroughWireFormat() throws InvalidProtocolBufferException {
    BuildEventStreamProtos.BuildEvent original =
