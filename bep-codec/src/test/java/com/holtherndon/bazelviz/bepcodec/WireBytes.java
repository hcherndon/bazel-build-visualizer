...
/**
 * Hand-writes protobuf wire bytes so tests can express messages this build's
 * generated code cannot describe — most importantly a field number no schema
 * here declares, which is what a future Bazel looks like on arrival.
 */
