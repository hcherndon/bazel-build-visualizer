...
/**
 * Benchmark tiers from plan section 20.1. Deterministic synthetic fixtures are
 * generated at these scales; the assumed system memory documents the machine
 * class each tier targets, it is not enforced.
 */
