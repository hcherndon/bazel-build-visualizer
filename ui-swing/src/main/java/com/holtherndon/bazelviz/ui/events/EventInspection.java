 ...
 *
 * <p>Four states rather than a nullable payload, because "nothing selected",
 * "loading", "loaded" and "could not be loaded" call for four different panes.
 * Collapsing the last two — showing an empty inspector when a journal read
 * fails — would look identical to an event whose payload is genuinely empty.
 *
 ...
 * @param loadFailure why nothing could be shown, present only in
 *     {@link State#FAILED}
 */
