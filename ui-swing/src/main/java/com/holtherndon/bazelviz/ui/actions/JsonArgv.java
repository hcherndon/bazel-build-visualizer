 ...
 *
 * <p>A dozen lines rather than a JSON binding because the shape is fixed — an
 * array of strings, written by this application's own writer — and because the
 * cost of being wrong is a command line rendered oddly rather than a value
 * misread. Anything it cannot parse comes back empty, and the caller shows the
 * stored text verbatim instead of guessing.
 */
