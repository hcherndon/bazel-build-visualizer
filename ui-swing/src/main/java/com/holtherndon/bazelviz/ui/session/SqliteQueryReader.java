 ...
 *
 * <p>Owns the connection it was handed and closes it, which is what keeps a
 * cancelled or failed query from leaking one: the view lets go of the reader,
 * the reader closes the connection, and {@code SqliteSessionSource} closes any
 * that outlive their view anyway.
 */
