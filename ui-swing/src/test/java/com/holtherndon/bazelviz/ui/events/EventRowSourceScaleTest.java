...
/**
 * The million-row random-access case, isolated for cache and runtime accounting.
 * It models a scroll-thumb jump with nothing fetched in between: the case
 * OFFSET paging would make slow and arithmetic anchoring must keep constant.
 */
