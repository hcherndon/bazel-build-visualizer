...
class EntityFormatTest {
    ...
    void measuredFieldsCarryTheirWarning() {
        Measured<Long> missing = Measured.unknown(
                DataSource.BEP, Completeness.UNAVAILABLE,
        ...
        Inspection.Field known = EntityFormat.durationField(
                "Duration", Measured.of(1_500L, DataSource.BEP));
