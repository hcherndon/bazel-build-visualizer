...
class TestInspectionTest {
    ...
    void flakyTestsShowTheirEvidence() {
        ...
        List<TestAttemptRow> attempts = List.of(
                attempt(1, TestOutcome.FAILED, false),
                attempt(2, TestOutcome.PASSED, false));
    ...
    void cachedAttemptsAreFlagged() {
        ...
        Inspection inspection = TestInspection.of(
                cached, List.of(attempt(1, TestOutcome.PASSED, true)), List.of());
    ...
    void logsAreLocations() {
        Inspection inspection = TestInspection.of(
                ...
                List.of(new TestQueries.TestLog(
