...
final class LimitEstimateTest {
    ...
    void traversalsAreBounded() {
        LimitEstimate estimate = LimitEstimate.of(
                GraphExtract.Mode.NEIGHBOURHOOD, 120_000, 400_000, 50_000, 200_000);
    ...
    void fittingGraphsAreSilent() {
        LimitEstimate estimate =
                LimitEstimate.of(GraphExtract.Mode.WHOLE, 900, 2_000, 50_000, 200_000);
    ...
    void theLimitIsInclusive() {
        assertThat(LimitEstimate.of(GraphExtract.Mode.WHOLE, 50_000, 200_000, 50_000, 200_000)
                        .fits())
                .isTrue();
        assertThat(LimitEstimate.of(GraphExtract.Mode.WHOLE, 50_001, 200_000, 50_000, 200_000)
                        .fits())
                .isFalse();
    }
}
