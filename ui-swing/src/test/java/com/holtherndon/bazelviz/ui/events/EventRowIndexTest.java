...
class EventRowIndexTest {
  ...
  void anchorsAreOnlyForPageStarts() {
    ...
    assertThatThrownBy(() -> index.anchorForRow(500)).isInstanceOf(IndexOutOfBoundsException.class);
  ...
  @Test
  @DisplayName(
      "a prediction that turns out wrong demotes the index and the fetch still lands right")
