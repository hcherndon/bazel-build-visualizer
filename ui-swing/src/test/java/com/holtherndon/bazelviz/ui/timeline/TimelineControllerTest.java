...
final class TimelineControllerTest {
    ...
    void windowRequestQueueIsBoundedAndLatestWins() {
        ...
        assertThat(requests.offer("running"))
                .as("the first request starts a reader")
                .isTrue();
    ...
    void latestDetailSelectionWins() throws Exception {
        ...
        onEdt(() -> {
            ...
            controller.view().showInspector(new SpanDetails(
                    "Action 2",
                    List.of("Fetching details…"),
                    List.of()));
            return null;
        });
        ...
        waitUntil(() -> onEdt(() -> controller.view().inspectorTitleForTest())
                .equals("//pkg:second"));
    }
    ...
    private record FakeSource(
            String url, AtomicInteger opens, Supplier<EntityReader> entityReaders)
    ...
    private static final class DetailReads {
        ...
        private EntityReader reader() {
            return (EntityReader) Proxy.newProxyInstance(
