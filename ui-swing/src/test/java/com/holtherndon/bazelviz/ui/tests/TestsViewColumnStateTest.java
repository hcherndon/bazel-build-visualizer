...
/**
 * The Tests tab's slice of the shared column machinery: no header sorts — the worst-first order is
 * documented product intent ({@link TestRowSource}) — and the headers say so instead of silently
 * not sorting.
 */
