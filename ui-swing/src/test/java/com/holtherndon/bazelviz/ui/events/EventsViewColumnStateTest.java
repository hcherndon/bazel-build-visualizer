...
/**
 * The Events tab's slice of the shared column machinery: honest tooltips on a table whose order is
 * fixed by design, and column visibility surviving the live-refresh model swap the same way widths
 * already do ({@code EventsViewLiveRefreshTest.refreshPreservesAResizedColumnWidth}).
 */
