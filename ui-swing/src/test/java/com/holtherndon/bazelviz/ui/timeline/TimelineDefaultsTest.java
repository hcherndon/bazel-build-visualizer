 ...
 *
 * <p>These are choices, not accidents: the previous defaults — Runner and "first activity" — were
 * whatever happened to be first in each enum, and Runner needs an execution log most sessions do
 * not have. These tests exist so a reordering of either enum cannot silently change what a fresh
 * timeline shows.
 */
