...
/**
 * How a weight becomes pixels: radius, thickness and colour, and what an unknown value must never
 * become.
 *
 * <p>Rule 11 has a visual form here: a node whose weight was not computed is grey at base size —
 * not the smallest, coldest node on screen, which is what treating unknown as zero would draw.
 */
