 ...
 *
 * <p>The raw location is what makes the inspector's "show the raw protobuf"
 * possible without ever having held the payload in memory: the UI asks for one
 * event, gets a segment/offset/length, and reads exactly those bytes back off
 * disk.
 *
