 ...
 *
 * <p>{@code arrivedEventId} is an {@link OptionalLong} rather than a sentinel:
 * "this child never arrived" is a finding the Events view reports (plan 17.11
 * missing-announced-child report), not a zero to be glossed over.
 *
 ...
 * @param arrivedEventId row id of the event that turned up carrying that hash,
 *     empty when none has
 */
