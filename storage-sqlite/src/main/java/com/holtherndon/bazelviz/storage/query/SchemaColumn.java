 ...
 * @param declaredType the declared type, which SQLite does not enforce; empty when the DDL declared
 *     none
 * @param notNull whether a NOT NULL constraint is declared
 * @param primaryKeyPosition 1-based position in the primary key, or 0 when the column is not part
 *     of one
 */
