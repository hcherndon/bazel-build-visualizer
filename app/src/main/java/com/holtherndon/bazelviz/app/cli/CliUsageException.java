 ...
 *
 * <p>Carries the subcommand it happened under so the handler can point at the
 * right {@code --help}. A stack trace is never printed for one of these: a typo
 * is a conversation with the user, not a defect report.
 */
