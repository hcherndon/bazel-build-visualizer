 ...
 *
 * <p>The three methods that launch a real host Bazel live in
 * {@link RealBazelCliRunTest}, split out during the Bazel migration so their
 * un-sandboxed, environment-inheriting test target cannot dilute the
 * treatment of these plain argument-contract tests.
 */
class CliRunTest {
